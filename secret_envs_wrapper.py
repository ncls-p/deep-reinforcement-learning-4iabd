...
class SecretEnv0Wrapper:
    def __init__(self):
        ...
        self.lib.secret_env_0_transition_probability.argtypes = [
            ctypes.c_size_t,
            ctypes.c_size_t,
            ctypes.c_size_t,
            ctypes.c_size_t,
        ...
        self.lib.secret_env_0_available_actions.restype = ctypes.POINTER(
            ctypes.c_size_t
        )
        ...
        self.lib.secret_env_0_available_actions_delete.argtypes = [
...
class SecretEnv0:
    ...
    def available_actions(self) -> np.ndarray:
        ...
        self.wrapper.lib.secret_env_0_available_actions_delete(
            actions_pointer, actions_len
        )
        return arr_copy
...
class SecretEnv1Wrapper:
    def __init__(self):
        ...
        self.lib.secret_env_1_transition_probability.argtypes = [
            ctypes.c_size_t,
            ctypes.c_size_t,
            ctypes.c_size_t,
            ctypes.c_size_t,
        ...
        self.lib.secret_env_1_available_actions.restype = ctypes.POINTER(
            ctypes.c_size_t
        )
        ...
        self.lib.secret_env_1_available_actions_delete.argtypes = [
            ctypes.POINTER(ctypes.c_size_t),
            ctypes.c_size_t,
        ]
...
class SecretEnv1:
    ...
    def available_actions(self) -> np.ndarray:
        ...
        arr = np.ctypeslib.as_array(actions_pointer, (actions_len,))
        arr_copy = np.copy(arr)
        self.wrapper.lib.secret_env_1_available_actions_delete(
            actions_pointer, actions_len
        )
        return arr_copy
...
class SecretEnv2Wrapper:
    def __init__(self):
        ...
        self.lib.secret_env_2_available_actions.restype = ctypes.POINTER(
            ctypes.c_size_t
        )
...
class SecretEnv2:
    ...
    def available_actions(self) -> np.ndarray:
        ...
        arr = np.ctypeslib.as_array(actions_pointer, (actions_len,))
        arr_copy = np.copy(arr)
        self.wrapper.lib.secret_env_2_available_actions_delete(
            actions_pointer, actions_len
        )
        return arr_copy
...
class SecretEnv3Wrapper:
    def __init__(self):
        ...
        self.lib.secret_env_3_available_actions.restype = ctypes.POINTER(
            ctypes.c_size_t
        )
...
class SecretEnv3:
    ...
    def available_actions(self) -> np.ndarray:
        ...
        arr = np.ctypeslib.as_array(actions_pointer, (actions_len,))
        arr_copy = np.copy(arr)
        self.wrapper.lib.secret_env_3_available_actions_delete(
            actions_pointer, actions_len
        )
        return arr_copy
